...
export const Sidebar = ({ type = 'teacher' }: SidebarProps) => {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-400 to-blue-700 h-full rounded-2xl w-[244px] flex flex-col items-center pt-8 px-4 gap-9 mr-5">
      ...
      <div className="flex flex-col w-full gap-6">
        {OPTIONS[type].map(option => (
          <Link to={option.href}>
            <div className={`flex gap-2 opacity-${pathname === option.href ? '100' : '70'} hover:opacity-100`}>
